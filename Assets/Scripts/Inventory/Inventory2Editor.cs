...
public class Inventory2Editor : Editor
{
    ...
    private const string inventory2PropItemImagesName = "itemImages";
    private const string inventory2PropItemsName = "items";

    
    //C'est ici que l'on précise vers quels champs de notre classe inventaire doivent pointer nos property
    private void OnEnable()
    {
        itemImagesProperty = serializedObject.FindProperty(inventory2PropItemImagesName);
        itemsProperty = serializedObject.FindProperty(inventory2PropItemsName);
    }
